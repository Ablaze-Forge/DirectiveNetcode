...
namespace AblazeForge.DirectiveNetcode.Logging
{
    ...
    public enum ErrorCodes : int
    {
        ...
        /// <summary>
        /// 0 is reserved for general logs. Should not be used for error reporting.
        /// </summary>
        [Obsolete("GeneralError is used only to reserve the value 0 for general logs. Please use specific error codes instead.", true)]
        GeneralError = 0,
    ...
    public enum WarningCodes : int
    {
        ...
        /// <summary>
        /// 0 is reserved for general logs. Should not be used for warning reporting.
        /// </summary>
        [Obsolete("GeneralWarning is used only to reserve the value 0 for general logs. Please use specific warning codes instead.", true)]
        GeneralWarning = 0,
